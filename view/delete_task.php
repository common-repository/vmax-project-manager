...
<div class="col-lg-12" style="border-bottom: 1px solid #b4b6b7; margin-bottom:20px;">
	<h3><img src="<?php echo plugins_url( 'assets/icons/delete.png', dirname(__FILE__) );?>" style="height: 60px">Delete task?</h3>
</div>
<?php
...
<form method="post" action="<?php echo admin_url();?>admin-post.php">
	...
	<input type="hidden" name="task" value="delete_task">
